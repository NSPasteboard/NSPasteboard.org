...
|TypeWhisper |https://github.com/TypeWhisper/typewhisper-mac |7|
...
5. Uses `org.nspasteboard.TransientType` and `org.nspasteboard.AutoGeneratedType` for the text replacements it performs in the pasteboard.
6. Detects `org.nspasteboard.ConcealedType`, offering options to user for handling concealed content (mask, skip, show).
7. Uses `org.nspasteboard.AutoGeneratedType` for the clipboard entries that it creates.
8. By default Maccy will ignore: `org.nspasteboard.TransientType`, `org.nspasteboard.ConcealedType`, and `org.nspasteboard.AutoGeneratedType`.
